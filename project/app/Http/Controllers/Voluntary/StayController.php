...
use App\Http\Resources\Voluntary\StayResource;
...
class StayController extends Controller
{
    ...
    {
        return view('voluntary.stays.index');
    }
    ...
    public function create()
    {
        ...
        return view('voluntary.stays.create', compact('stay', 'clients', 'sources', 'users'));
    }
    ...
    public function store(StayRequest $request)
    {
        ...
        return $this->chooseReturn('success', $message, 'voluntary.estadias.index');
    }
    ...
    public function edit($id)
    {
        ...
        $sources = (new SourceRepository())->all();
        return view('voluntary.stays.edit', compact('stay', 'users', 'clients', 'sources'));
    }
    ...
    {
        return view('voluntary.stays.show', compact('source'));
    }
