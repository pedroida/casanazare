...
@section('content')
    <data-list
            data-source="{{ route('voluntary.pagination.stays') }}"
            delete-message="@lang('flash.common.confirmation.destroy')"
            url-create="{{ route('voluntary.estadias.create') }}"
                    ...
                    @can('stays create')
                        ...
                        <div class="col-12 text-md-right">
                            ...
                            @can('stays import')
                                <import-spreadsheet
                                        class="float-right"
                                        post-url="{{ route('voluntary.estadias.import-spreadsheet') }}"
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-striped table-md table-vcenter mb-0">
                            <thead>
                            @include('voluntary.stays._partials.head')
                            </thead>
                            <tbody>
                            <tr v-if="emptyResult">
                            ...
                            <template v-else>
                                <tr v-for="(item, index) in items" :key="index">
                                    @include('voluntary.stays._partials.body')
                                </tr>
                            </template>
                            </tbody>
                        </table>
