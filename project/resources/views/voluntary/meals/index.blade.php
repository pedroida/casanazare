...
@section('modal-section')
    <meal-modal
            store-url="{{ route('voluntary.refeicoes.store') }}"
            update-url="{{ route('voluntary.refeicoes.update', ':id') }}">
    </meal-modal>
@endsection

@section('content')
    <data-list
            data-source="{{ route('voluntary.pagination.meals') }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row" v-else>
                        <div v-for="(item, index) in items" :key="index" class="col-md-3 col-12">
                            @include('voluntary.meals._partials.card')
                        </div>
