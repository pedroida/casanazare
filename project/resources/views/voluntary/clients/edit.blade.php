...
@section('page-header')
    ...
    <breadcrumb>
        ...
        <breadcrumb-item href="{{ route('voluntary.acolhidos.index') }}">
...
<div class="card card-secondary">
    <form class="form-horizontal" method="POST" action="{{ route('voluntary.acolhidos.update', $client) }}">
        @method('PUT')
        <div class="card-body pb-0">
            @include('voluntary.clients._partials.form')
        </div>
