...
class StayControllerTest extends TestCaseFeature
{
    /**
     *
     * @return void
    ...
    {
        $response = $this->get('/admin/estadias');
    ...
    public function testShouldBringStayInPagination()
    {
        ...
        $response = $this->getJson('/pagination/admin/stays');
        $response->assertJson([
            'data' => [
                [
    ...
    {
        $response = $this->get('/admin/estadias/create');
    ...
    public function testShouldCreateStay()
    {
        ...
        $response = $this->post('/admin/estadias', $stay);
    ...
    public function testShouldShowEditStay()
    {
        ...
        $response = $this->get('/admin/estadias/' . $stay->id . '/edit');
    ...
    public function testShouldEditStay()
    {
        ...
        $response = $this->put("/admin/estadias/{$stay->id}", $stay->toArray());
    ...
    public function testShouldNotEditStay()
    {
        ...
        $response = $this->put("/admin/estadias/{$stay->id}", $emptyStay);
    ...
    {
        $stay = factory(Stay::class)->create();
        $response = $this->delete("/admin/estadias/{$stay->id}");
